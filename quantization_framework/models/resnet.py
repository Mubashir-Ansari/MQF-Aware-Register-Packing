"""ResNet models compatible with legacy serialized checkpoints and current loaders."""
...
class ResNet(nn.Module):
    def __init__(
        ...
        # Legacy GTSRB models in this repo use 32x32-like input settings.
...
def resnet18(pretrained=False, progress=True, device="cpu", **kwargs):
    del pretrained, progress, device
...
def ResNet18(num_classes=43):
    """Compatibility wrapper used by the existing loader."""
